	...
	navGroups: [
		...
		},
		{
			...
			items: [
				...
				{ title: "RSVP", url: "/invitations/$invitationId/rsvp", icon: Mail },
				{
					title: "Analytics",
		...
		<Sidebar className="border-r border-gray-200 font-sans">
			<SidebarHeader className="pt-5 px-4 pb-2">
				<div className="flex items-center gap-3 px-2 mb-4">
					<div className="w-8 h-8 bg-[#111827] text-white rounded-md flex items-center justify-center font-bold text-lg">
						S
					</div>
					<span className="font-bold text-lg text-gray-900">Stitch</span>
				</div>
